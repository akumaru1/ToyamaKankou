...
class ChooseShokujiEn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnHimi.setOnClickListener {
            startKankouchiActivity("gurume1en.json")
        }
        btnToyama.setOnClickListener {
            startKankouchiActivity("gurume2en.json")
        }
        btnKurobe.setOnClickListener {
            startKankouchiActivity("gurume3en.json")
        }
