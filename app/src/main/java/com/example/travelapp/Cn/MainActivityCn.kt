...
class MainActivityCn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnKankouchi.setOnClickListener {
            val intent = Intent(this, ChooseKankouchiCn::class.java)
            startActivity(intent)
        }

        val btnFood : ImageButton = findViewById(R.id.btnFood)
        btnFood.setOnClickListener {
            val intent = Intent(this, ChooseShokujiCn::class.java)
            startActivity(intent)
        }

        val btnManner : ImageButton = findViewById(R.id.btnManner)
        btnManner.setOnClickListener {
            val intent = Intent(this, MannerCn::class.java)
            startActivity(intent)
        }
        ...
        btnEvent.setOnClickListener {
            ...
            intent.putExtra("JSON_FILE_NAME", "eventcn.json")
            startActivity(intent)
        }
        ...
        btnBunka.setOnClickListener {
            ...
            intent.putExtra("JSON_FILE_NAME", "bunkacn.json")
            startActivity(intent)
        }
        ...
        btnkansui.setOnClickListener {
            ...
            intent.putExtra("JSON_FILE_NAME", "kankou2cn.json")
        ...
        btnAma.setOnClickListener {
            val intent = Intent(this, DetailActivity::class.java)
            intent.putExtra("JSON_FILE_NAME", "kankou1cn.json")
            intent.putExtra(ROW_POSITION, 0)
            startActivity(intent)
        }
        ...
        btnkurobe.setOnClickListener {
            val intent = Intent(this, DetailActivity::class.java)
            intent.putExtra("JSON_FILE_NAME", "kankou3cn.json")
        ...
        btnramen.setOnClickListener {
            val intent = Intent(this, DetailActivity::class.java)
            intent.putExtra("JSON_FILE_NAME", "gurume2cn.json")
            intent.putExtra(ROW_POSITION, 1)
            startActivity(intent)
        }
